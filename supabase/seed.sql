...
INSERT INTO public.education (profile_id, program, major, year_started, year_graduated, honors) VALUES
  ('b0000000-0000-0000-0000-000000000002', 'BSIT', 'Web Development', 2015, 2019, 'Cum Laude'),
  ('b0000000-0000-0000-0000-000000000003', 'BSIT', 'Web Development', 2019, 2023, NULL),
  ('b0000000-0000-0000-0000-000000000004', 'BSIT', 'Data Science', 2014, 2018, 'Magna Cum Laude');

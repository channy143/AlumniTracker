...
if (!supabaseUrl || !supabaseServiceKey) {
  console.error(
    '[supabase] Missing required environment variables: SUPABASE_URL and/or SUPABASE_SERVICE_KEY. ' +
...
export function createUserScopedClient(userJwt: string): SupabaseClient {
  ...
  if (!supabase) {
    throw new Error('Supabase client is not configured. Set SUPABASE_URL and SUPABASE_SERVICE_KEY.');
  }

...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Try refreshing the page. The charts load from live alumni data, so if the API is temporarily unavailable the charts will show an empty state until the connection is restored. Clear your browser cache or try a different browser if the issue persists.',
  },
  {
    category: 'Technical',
        ...
        <div className="space-y-3 text-xs text-gray-600">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Contact the Alumni Office in person or by email for phone support.</span>
            </div>
          </div>

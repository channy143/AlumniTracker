...
export default function ReportsPage() {
  ...
  const reports = [
    ...
    },
    {
      ...
      exportCsv: () => handleExport(() => adminApi.salaryDistributionCsv(), 'salary-distribution.csv', 'salary-csv'),
    ...
    },
    {
      ...
      exportCsv: () => handleExport(() => adminApi.employmentByCourseCsv(), 'employment-rate-by-course.csv', 'erate-csv'),
    ...
    },
    {
      ...
      exportCsv: () => handleExport(() => adminApi.degreeAlignmentCsv(), 'degree-alignment.csv', 'curriculum-csv'),

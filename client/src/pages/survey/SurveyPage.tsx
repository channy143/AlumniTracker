    ...
    return (
      <div className="max-w-3xl mx-auto py-6">
        <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-gray-900 mb-2">This survey has closed</h2>
          <p className="text-sm text-gray-500 mb-4">The {survey.title} is no longer accepting responses. Please wait for the next survey cycle.</p>

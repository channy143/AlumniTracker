      ...
      <div className="w-full grid grid-cols-3 items-center">
        ...
        <div className="flex items-center gap-1 justify-end">
          ...
          <div className="relative ml-1 pl-2 border-l border-gray-200" ref={dropdownRef}>
            ...
            >
              <div className="w-7 h-7 rounded-full bg-blue-800 flex items-center justify-center text-white text-xs font-medium hover:ring-2 hover:ring-blue-300 transition-all">
